...
Thanks for considering a contribution to pyrig-pypi! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/pyrig-pypi/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/pyrig-pypi/actions/workflows/health_check.yml) must pass before merge.
